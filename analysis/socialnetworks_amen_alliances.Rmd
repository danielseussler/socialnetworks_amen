...
Thus, as dyadic effects I include the geographic distance, a capability ratio, a measure for political similarity and a conflict indicator. The capability ratio is defined as the log of the relative *Composite Index of National Capability* of both countries, with the stronger state as numerator. Political similiarity is measured with the relative deviation of the *polity score*. This yields the following effects for each country pair $(i,j)$: 
...
See @geometryofsecurity for the theoretic reasoning behind these indicators. 




```{r ame_geom_evol_R2, results ='asis', message = FALSE}
