...
fit_AME_Rep_R3 <- readRDS(file = "models/fit_AME_Rep_R3.rds")
stargazer(cbind(fit_AME_Rep_R3$BETA,fit_AME_Rep_R3$VC), type = "latex", header = FALSE, summary = TRUE, summary.stat = c("n", "mean", "sd"), t.auto = TRUE, title = "Estimated Effects for AME Replicated Data")
```
...
```{r, results ='asis', message = FALSE}
fit_AME_Rep_R3 <- readRDS(file = "models/fit_AME_Rep_R3.rds")
stargazer(table_ame(fit_AME_Rep_R3), type = "latex", header = FALSE,
          summary = FALSE, title = "Estimated Effects for AME Replicated Data",
          notes = "MCMC Estimates of 500 Burn-In and 10000 Draws.")
```
